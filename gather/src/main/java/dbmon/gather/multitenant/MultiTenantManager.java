...
public class MultiTenantManager {
    ...
    public void setCurrentTenant(String tenantId) throws SQLException, TenantNotFoundException, TenantResolvingException {
        if (tenantIsAbsent(tenantId)) {
            if (tenantResolver != null) {
                ...
                addTenant(tenantId, url, driverClassName, username, password);
            } else {
    ...
    public void addTenant(String tenantId, String url, String driverClassName, String username, String password) throws SQLException {
